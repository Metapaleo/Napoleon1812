#!/usr/bin/env bash
#
#SBATCH -o BLASTN_hits2.out -e BLASTN_hits2.err
#SBATCH --qos=normal
#SBATCH --cpus-per-task=30
#SBATCH --mem=20G
#SBATCH --qos=normal
#SBATCH --job-name BLASTN_hits
#SBATCH -p depgg,metapaleo,common

module load apptainer

wdir=$(echo "${HOME}/02_S.enterica")
nthread=$(echo "30")
...
for sample in `grep -vFwf 02_blast_hits/b  samples.ids`; do \
